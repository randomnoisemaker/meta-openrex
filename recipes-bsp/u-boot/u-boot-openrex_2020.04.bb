...
require u-boot-openrex-common_${PV}.inc
...
COMPATIBLE_MACHINE = "(mxs|mx5|mx6|mx7|vf|use-mainline-bsp|imx6q-openrex|imx6s-openrex)"
#COMPATIBLE_MACHINE = "(mxs|mx5|mx6|mx7|vf|use-mainline-bsp|imx6q-openrex)"
